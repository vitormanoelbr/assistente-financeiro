...
st.sidebar.markdown("---")
st.sidebar.caption(
    "Etapa atual: somente o Diagnóstico consulta dados. "
...
st.markdown("---")
st.caption(
    "Teste controlado: troque entre todas as páginas várias vezes. "
    "Somente o Diagnóstico realiza uma consulta ao banco."
)
